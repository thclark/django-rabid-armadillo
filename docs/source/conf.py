...
latex_documents = [
  ('index', 'rabid_armadillo.tex', u'Rabid Armadillo',
...
man_pages = [
    ('index', 'rabid_armadillo', u'Rabid Armadillo',
     [u'<copyright_owner>'], 1)
]
...
texinfo_documents = [
  ('index', 'rabid_armadillo', u'Rabid Armadillo',
   u'<copyright_owner>', 'Rabid Armadillo', 'Rabid Armadillo is a library to help armadillos with their rabies problems.',
   'Miscellaneous'),
]
